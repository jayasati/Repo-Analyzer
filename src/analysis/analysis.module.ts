...
// ArchitectureMetricsService is listed before ArchitectureScoreService so that
// NestJS can satisfy its constructor dependency within the same module.
const ANALYSIS_PROVIDERS = [
  PackageGraphService,
  CycleDetectorService,
  SmellDetectorService,
  ArchitectureMetricsService,
  ArchitectureScoreService,   // depends on ArchitectureMetricsService (injected via constructor)
  RepoSummaryService,
